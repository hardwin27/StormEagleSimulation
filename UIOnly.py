...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.lbl_Movement.setGeometry(QtCore.QRect(720, 120, MainWindow.width() - 720, 20))
        font = QtGui.QFont()
        ...
        self.lbl_Gust.setGeometry(QtCore.QRect(720, 150, MainWindow.width() - 720, 20))
        font = QtGui.QFont()
        font.setFamily("8514oem")
        ...
        self.lbl_Egg.setGeometry(QtCore.QRect(720, 180, MainWindow.width() - 720, 20))
        font = QtGui.QFont()
        font.setFamily("8514oem")
        ...
        self.lbl_Reappear.setGeometry(QtCore.QRect(720, 210, MainWindow.width() - 720, 20))
        font = QtGui.QFont()
        font.setFamily("8514oem")
        ...
        self.lbl_Dive.setGeometry(QtCore.QRect(720, 240, MainWindow.width() - 720, 20))
        font = QtGui.QFont()
        font.setFamily("8514oem")
        ...
        self.lbl_Storm.setGeometry(QtCore.QRect(720, 270, MainWindow.width() - 720, 20))
        font = QtGui.QFont()
        font.setFamily("8514oem")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_Movement.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">Fly: Arrow Key</span></p></body></html>"))
